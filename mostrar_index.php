...
$consulta="SELECT id_producto, SUM(nivex) AS cantidad_total
FROM inventario 
...
$arrar_cantidad[]= $row["cantidad_total"];
...
while ($i< count($arrar_id)){
    ...
    if ($result->num_rows > 0) {
        ...
        echo "<tr><th>ID</th><th>Nombre</th><th >Descripcion</th><th>Precio</th><th>ID_Proveedor</th><th>ID_Categoría</th><th>Stock</th> <th>Imagen</th></tr>";
